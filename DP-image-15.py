...
if __name__ == "__main__":
    point_1, density_1, shade_left_1, density_left_1, shade_right_1, density_right_1 = (
        cal_dis_val.cal_dis_val(scipy.stats.laplace, 1e-2, 1000, 0, 2)
    )
    point_2, density_2, shade_left_2, density_left_2, shade_right_2, density_right_2 = (
        cal_dis_val.cal_dis_val(scipy.stats.laplace, 1e-2, 1000, 3, 2)
    )
    ...
    plot_plot.save("DP-image/15.png", dpi=300)
    # plot_plot.show()
